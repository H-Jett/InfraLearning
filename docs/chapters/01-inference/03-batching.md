...
======================================================================
 batch |      解码耗时(s) |       每步延迟(ms) |      吞吐(tok/s) |      相对b=1加速
----------------------------------------------------------------------
     1 |        1.045 |          16.32 |           61.3 |         1.0x
     2 |        1.066 |          16.65 |          120.1 |         2.0x
     4 |        1.066 |          16.66 |          240.1 |         3.9x
     8 |        1.069 |          16.70 |          479.1 |         7.8x
    16 |        1.059 |          16.55 |          966.6 |        15.8x
    32 |        1.076 |          16.81 |         1903.6 |        31.1x
    64 |        1.076 |          16.81 |         3807.7 |        62.2x
   128 |        1.070 |          16.72 |         7655.9 |       125.0x
   256 |        1.100 |          17.18 |        14897.0 |       243.2x
   512 |        1.192 |          18.63 |        27485.6 |       448.7x
  1024 |        1.920 |          29.99 |        34139.2 |       557.3x

读表：吞吐一路往上涨说明 batching 在生效（权重搬一次喂一批）；
      若某个 batch 之后吞吐涨幅骤减、每步延迟明显变大，那里就是 memory-bound → compute-bound 的翻转点。

======================================================================
实验 B：static batching 的长尾浪费（模拟，不需要真跑模型）
======================================================================
请求数 = 32，输出长度范围 = [13, 255]，总有用 token = 4110
static batching 计算的 token-步 = 32 × 255 = 8160
其中浪费（短序列空转）= 4050  →  浪费率 49.6%
